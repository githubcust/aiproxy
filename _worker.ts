...
const base64Encode = uint8ArrayToBase64;
const base64Decode = base64ToUint8Array;
...
async function kh(n: { userId: string; clientUUID: string }, fixedIv?: Uint8Array): Promise<string> {
  ...
  const encrypted = await crypto.subtle.encrypt({ name: "AES-CBC", iv: t }, key, new Uint8Array(paddedData));
